package com.greensock.plugins
{
   ...
   public class BezierPlugin extends TweenPlugin
   {
      ...
      public static function _parseBezierData(values:Array, type:String, prepend:Object = null) : Object
      {
         ...
         while(--i > -1)
         {
            ...
            for(j = 0; j < l; j += inc)
            {
               ...
               _loc19_ = cnt++;
               cur[_loc19_] = inc === 3 ? new Segment(a,b,c,d) : new Segment(a,(2 * b + a) / 3,(2 * b + c) / 3,c);
            }
            cur.length = cnt;
         }
         return obj;
      ...
      override public function _onInitTween(target:Object, value:*, tween:TweenLite) : Boolean
      {
         ...
         this._autoRotate = Boolean(autoRotate) ? (autoRotate is Array ? autoRotate as Array : [["x","y","rotation",autoRotate === true ? 0 : Number(autoRotate)]]) : null;
         if(second is Point)
         {
            this._props = ["x","y"];
         }
         ...
         this._startRatio = Boolean(tween.vars.runBackwards) ? 1 : 0;
         return true;
      }
      ...
      override public function setRatio(v:Number) : void
      {
         ...
         var notStart:Boolean = v !== this._startRatio;
         if(this._timeRes == 0)
         {

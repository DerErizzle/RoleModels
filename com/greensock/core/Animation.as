   ...
   public class Animation
   {
      ...
      public function Animation(duration:Number = 0, vars:Object = null)
      {
         ...
         if(_rootTimeline == null)
         {
            ...
            _rootTimeline._startTime = Platform.instance.getTimer() / 1000;
      ...
      {
         ++_rootFrame;
         _rootTimeline.render((Platform.instance.getTimer() / 1000 - _rootTimeline._startTime) * _rootTimeline._timeScale,false,false);

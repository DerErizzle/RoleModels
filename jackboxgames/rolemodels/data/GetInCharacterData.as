...
{
   public class GetInCharacterData implements IRevealData
   {
      ...
      public function GetInCharacterData(revealConstants:RevealConstants, roleData:RoleData, primaryPlayers:Array, votingPlayers:Array, prompt:String, idx:int)
      {
         super();

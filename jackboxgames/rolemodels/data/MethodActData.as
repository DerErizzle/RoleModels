...
{
   public class MethodActData implements IRevealData
   {
      ...
      public function MethodActData(revealConstants:RevealConstants, roleData:RoleData, primaryPlayers:Array, votingPlayers:Array, prompt:String, idx:int)
      {
         super();

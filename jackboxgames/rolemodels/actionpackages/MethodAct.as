package jackboxgames.rolemodels.actionpackages
{
   ...
   public class MethodAct extends JBGActionPackage implements IResultVoteHandler
   {
       
      
      private var _promptText:String;
      
      private var _revealData:MethodActData;
      ...
      public function MethodAct(sourceURL:String)
      {
         super(sourceURL);
      }
      ...
      private function _onLoaded() : void
      {
         ...
         {
            return {"html":LocalizationUtil.getPrintfText("METHOD_ACT_VOTE_PROMPT")};
         ...
         GameState.instance.gameAudience.setResultVoteHandler(GameConstants.REVEAL_CONSTANTS.methodAct.name,this);
         this._audienceVotes = new PerPlayerContainer();
      }
      
      public function handleActionReset(ref:IActionRef, params:Object) : void
      {
         JBGUtil.reset([this._voteInteraction,this._votingAudienceInputter,this._audienceVotes]);
         ref.end();
      }
      
      public function handleActionStart(ref:IActionRef, params:Object) : void
      {
         this._revealData = MethodActData(GameState.instance.currentReveal);

package jackboxgames.rolemodels.actionpackages
{
   ...
   public class Recount extends JBGActionPackage implements IResultVoteHandler
   {
      ...
      {
         return LocalizationUtil.getPrintfText("RECOUNT_INSTRUCTION_PROMPT");
      }
      ...
      private function _onLoaded() : void
      {
         ...
         {
            return {"html":LocalizationUtil.getPrintfText("RECOUNT_VOTE_PROMPT",_revealData.roleData.name.toUpperCase())};
         ...
         GameState.instance.gameAudience.setResultVoteHandler(GameConstants.REVEAL_CONSTANTS.recount.name,this);
         this._audienceVotes = new PerPlayerContainer();
      }
      
      public function handleActionReset(ref:IActionRef, params:Object) : void
      {
         JBGUtil.reset([this._voteInteraction,this._voteResults,this._votingAudienceInputter,this._audienceVotes]);
         ref.end();
      }
      
      public function handleActionStart(ref:IActionRef, params:Object) : void
      {
         this._revealData = RecountData(GameState.instance.currentReveal);
      ...
      {
         return LocalizationUtil.getPrintfText("RECOUNT_VOTE_PROMPT",this._revealData.roleData.name.toUpperCase());
      }
